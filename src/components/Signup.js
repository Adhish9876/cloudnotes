...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#191A23] pt-24">
      {/* Left: Form */}
      <div className="flex-1 flex items-center justify-center bg-[#191A23] px-4 py-12">
        <div className="bg-[#23243a] rounded-2xl shadow-2xl p-14 w-full max-w-lg mx-auto">
          <img src="/cloud.png" alt="Cloud Logo" className="mx-auto mb-6 w-12 h-12 object-contain" />
      ...
      <div className="hidden md:flex flex-1 items-center justify-center bg-[#23243a]">
        {/* You can replace this with an SVG or illustration */}
        <div className="w-3/4 h-3/4 flex items-center justify-center">
          <img src="/cloud.png" alt="Cloud Illustration" className="w-48 h-48 opacity-30" />
        </div>
      </div>
    </div>
  );
